...
public class IMCKPSPublicSoap
{
    ...
    public IMCKPSPublicSoap(){}

    public IMCKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public IMCKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        IMCExtendedSoapSerializationEnvelope envelope= new IMCExtendedSoapSerializationEnvelope(IMCExtendedSoapSerializationEnvelope.VER11);
