...
public class IMCExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(IMCDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new IMCStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static IMCDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static IMCDateTimeConverter dateTimeConverter = new IMCStandardDateTimeConverter();

    public IMCExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public IMCExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new IMCMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=IMCHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,IMCExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=IMCHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
