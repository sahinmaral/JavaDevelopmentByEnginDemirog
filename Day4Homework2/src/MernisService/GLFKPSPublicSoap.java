...
public class GLFKPSPublicSoap
{
    ...
    public GLFKPSPublicSoap(){}

    public GLFKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public GLFKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        GLFExtendedSoapSerializationEnvelope envelope= new GLFExtendedSoapSerializationEnvelope(GLFExtendedSoapSerializationEnvelope.VER11);
