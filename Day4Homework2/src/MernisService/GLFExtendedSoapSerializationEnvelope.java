...
public class GLFExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(GLFDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new GLFStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static GLFDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static GLFDateTimeConverter dateTimeConverter = new GLFStandardDateTimeConverter();

    public GLFExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public GLFExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new GLFMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=GLFHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,GLFExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=GLFHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
