...
public class NVRExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(NVRDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new NVRStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static NVRDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static NVRDateTimeConverter dateTimeConverter = new NVRStandardDateTimeConverter();

    public NVRExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public NVRExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new NVRMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=NVRHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,NVRExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=NVRHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
