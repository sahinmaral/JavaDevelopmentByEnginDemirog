...
public class NVRKPSPublicSoap
{
    ...
    public NVRKPSPublicSoap(){}

    public NVRKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public NVRKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        NVRExtendedSoapSerializationEnvelope envelope= new NVRExtendedSoapSerializationEnvelope(NVRExtendedSoapSerializationEnvelope.VER11);
